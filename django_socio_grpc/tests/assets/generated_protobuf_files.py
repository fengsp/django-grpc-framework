...
service ForeignModelController {
    ...
    rpc Destroy(ForeignModel) returns (google.protobuf.Empty) {}
}
...
service ManyManyModelController {
    ...
    rpc Destroy(ManyManyModel) returns (google.protobuf.Empty) {}
}
...
service RelatedFieldModelController {
    ...
    rpc Destroy(RelatedFieldModel) returns (google.protobuf.Empty) {}
}
